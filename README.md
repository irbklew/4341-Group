You can use github through the website or locally on your computer. 
...
Then after making you finish making changes to anything then need to type the following commands to send your changes to github: 
